...
internal partial class JavaInteropTypeMap
{
    ...
    // optional
    // - the body of this method will be generated by trimmer/ilc
    [GenerateStaticInterfaceMethodInvocation(typeof(IJavaInteropFunctionPointerResolver), nameof(IJavaInteropFunctionPointerResolver.GetFunctionPointer))]
    public partial IntPtr GetFunctionPointer(ReadOnlySpan<byte> key, int methodKey); // the signature is (TKey key[, parameter1, parameter2, ...]) - in this case the methodKey is the parameter passed to IJavaInteropMethodResolver.GetFunctionPointer 
}

// Q: Is there some thread which would discuss calling static abstract interface methods on type instances?
// something like:
//
// public IntPtr GetFunctionPointer(Type type, int methodKey) {
...
partial class JavaInteropTypeMap
{
    ...
    public partial IntPtr GetFunctionPointer(ReadOnlySpan<byte> key, int methodKey)
    {
        if (!_typeIndex.TryGetIndex(key, out var index))
        {
        ...
        return index switch
        {
            0 => GetFunctionPointer<Class2>(methodKey),
            1 => GetFunctionPointer<Class18>(methodKey),
            2 => GetFunctionPointer<Class15>(methodKey),
            3 => GetFunctionPointer<Class16>(methodKey),
            4 => GetFunctionPointer<Class38>(methodKey),
            5 => GetFunctionPointer<Class36>(methodKey),
            6 => GetFunctionPointer<Class7>(methodKey),
            7 => GetFunctionPointer<Class31>(methodKey),
            8 => GetFunctionPointer<Class9>(methodKey),
            9 => GetFunctionPointer<Class27>(methodKey),
            10 => GetFunctionPointer<Class11>(methodKey),
            11 => GetFunctionPointer<Class21>(methodKey),
            12 => GetFunctionPointer<Class10>(methodKey),
            13 => GetFunctionPointer<Class4>(methodKey),
            14 => GetFunctionPointer<Class37>(methodKey),
            15 => GetFunctionPointer<Class30>(methodKey),
            16 => GetFunctionPointer<Class26>(methodKey),
            17 => GetFunctionPointer<Class5>(methodKey),
            18 => GetFunctionPointer<Class12>(methodKey),
            19 => GetFunctionPointer<Class32>(methodKey),
            20 => GetFunctionPointer<Class29>(methodKey),
            21 => GetFunctionPointer<Class39>(methodKey),
            22 => GetFunctionPointer<Class25>(methodKey),
            23 => GetFunctionPointer<Class1>(methodKey),
            ...
            25 => GetFunctionPointer<Class0>(methodKey),
            26 => GetFunctionPointer<Class22>(methodKey),
            27 => GetFunctionPointer<Class3>(methodKey),
            28 => GetFunctionPointer<Class8>(methodKey),
            29 => GetFunctionPointer<Class14>(methodKey),
            30 => GetFunctionPointer<Class28>(methodKey),
            31 => GetFunctionPointer<Class20>(methodKey),
            32 => GetFunctionPointer<Class19>(methodKey),
            33 => GetFunctionPointer<Class6>(methodKey),
            34 => GetFunctionPointer<Class34>(methodKey),
            35 => GetFunctionPointer<Class17>(methodKey),
            36 => GetFunctionPointer<Class13>(methodKey),
            37 => GetFunctionPointer<Class33>(methodKey),
            38 => GetFunctionPointer<Class35>(methodKey),
            39 => GetFunctionPointer<Class23>(methodKey),
            40 => GetFunctionPointer<Class24>(methodKey),
            _ => default,
        };

        static IntPtr GetFunctionPointer<T>(int methodKey)
            where T : IJavaInteropFunctionPointerResolver // -- this is generated based on the `Type constraint` in the attribute
        {
            Console.WriteLine($"Calling GetFunctionPointer<{typeof(T).Name}>({methodKey})");
            return T.GetFunctionPointer(methodKey);
        }
    }
}
